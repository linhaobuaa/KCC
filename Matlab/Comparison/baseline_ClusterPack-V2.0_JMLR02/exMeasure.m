function [Acc, Rn, NMI, VIn, VDn, labelnum, ncluster, cmatrix] = exMeasure(cluster,true_label)
%==========================================================================
% FUNCTION: [Acc, Rn, NMI, VIn, VDn, labelnum, ncluster, cmatrix] = exMeasure(cluster,true_label)
% DESCRIPTION: This function is used to assess and evaluate clustering quality.
%
% INPUTS:   cluster = the clustering decision matrix returned by some
%                     algorithm
%           true_label = the true labels for n data points
%
...
%           labelnum = number of unique true labels
%           ncluster = number of clusters returned by some algorithm
%           cmatrix = contigency matrix
%
%==========================================================================
